...
Copied from OSL-Dynamics push:
https://github.com/OHBA-analysis/osl-dynamics/commit/ed5da5e5738dfcdaa9f75a0303406697fd522c02

This was only done to keep surface plotting functions in the custom scripts as they are after upgrading
osl-dynamics, which change power.save() function.
