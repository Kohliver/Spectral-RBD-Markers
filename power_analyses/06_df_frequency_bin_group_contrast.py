"""
Claculate frequency bin power group contrasts with GLMs accounting for confounds.
Cluster-permutation testing and max-tstatistic pooling accross frequency bins and parcels used to
...
plot_dir = '.../RBD_x_PD/Glasser52/rest/results/static/metrics/df_spect/glms'
outdir = '.../RBD_x_PD/Glasser52/rest/data/static/df_spect/contrasts'

# Load Power
f = np.load(f"{metric_dir}/defooofed_f.npy")
psd = np.load(f"{metric_dir}/defooofed_psd.npy")
psd = psd[:,:,f <= 35]
