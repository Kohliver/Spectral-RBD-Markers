"""
Project results of GLMs comparing groups on brain surface.
Surface plots presented in Figure 2 in Manuscript.
"""
...
outdir = '.../RBD_x_PD/Glasser52/rest/results/static/metrics/df_band_power/glms'
