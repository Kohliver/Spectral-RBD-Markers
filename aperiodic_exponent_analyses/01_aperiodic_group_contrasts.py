"""
Calculate group contrasts for aperiodic exponents with GLMs.
Significant assessed with permutation testing and max t-statistic pooling across parcels.
GLMs account for confounds.
"""
...
plot_dir = '.../RBD_x_PD/Glasser52/rest/results/static/metrics/aperiodic/glms'
outdir = '.../RBD_x_PD/Glasser52/rest/data/static/aperiodic'
...
def do_stats(contrast_idx, metric="tstats"):
    ...
    perm = glm.permutations.MaxStatPermutation(
        ...
        pooled_dims=(1),  # pool over parcels
        nprocesses=16,
    )
