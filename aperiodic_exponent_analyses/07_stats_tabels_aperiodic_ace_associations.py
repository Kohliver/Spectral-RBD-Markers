...
Get tabesls with stats for aperiodic compnent x ACE correlations/
This table is presented in the SI of the manuscript.
"""
...
outdir = '.../RBD_x_PD/Glasser52/rest/results/static/metrics/aperiodic/associations/ace/stats'
dvs = ["aperiodic"]
